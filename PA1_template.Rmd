...
cat("by Ionel M.,", today[1], ",", today[2:3], today[5])
```
...
```{r histogram_of_steps_from_activity_without_NA, fig.width=7, fig.height=10, fig.width=12, fig.path="./figures/", tidy=TRUE}
...
```{r avrg_daily_steps,fig.width=7, fig.height=10, fig.width=12, tidy=TRUE, fig.path= "./figures/"}
...
```{r histogram_of_steps_from_updated_activity, fig.width=7, fig.height=10, fig.width=12, fig.path="./figures/", tidy=TRUE}
...
```{r avrg_weedays_steps,fig.width=7, fig.height=10, fig.width=12, tidy=TRUE, fig.path= "./figures/"}
par(mfrow = c(2,1))
